...
export const AGENT_SYSTEM_PROMPT: string = [
  ...
  '- Do NOT return "done" until you have actually performed the task. Run the command(s) first; never',
  '  claim success (or describe an outcome) for something you have not done. Even a one-step goal like',
  '  "go to ~/projects" needs an actual "continue" step (e.g. `cd ~/projects && pwd`) before "done".',
